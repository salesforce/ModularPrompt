...
let "seed=42+$run_idx"
data_files=("5stages_fix/100shot_$run_idx hp20_$run_idx")
stage_ids=('0 none 0')
    ...
    do
      ...
      do
          ...
          python -m torch.distributed.launch --nproc_per_node 1 --master_port 2953$gpu_id main.py \
                  ...
                  --train_file_name ./data/huffpost/$data_file$/train.txt \
                  --valid_file_name ./data/huffpost/$data_file$/valid.txt \
                  --test_file_name ./data/huffpost/$data_file\_$stage_num/test.txt \
