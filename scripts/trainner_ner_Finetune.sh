...
let "seed=42+$run_idx"
data_files=("4stages_fixed/50shot_$run_idx few4_$run_idx")
    ...
    do
      ...
      do
          ...
          python -m torch.distributed.launch --nproc_per_node 1 --master_port 2953$gpu_id main.py \
                  ...
                  --train_file_name ./data/fewNERD/$data_file$/train.txt \
                  --valid_file_name ./data/fewNERD/$data_file$/dev.txt \
                  --test_file_name ./data/fewNERD/$data_file\_$stage_num/test.txt \
                  --gradient_accumulation_steps 1 \
                  --batch_size_per_gpu 8 \
                  --valid_size_per_gpu 20 \
                  --test_size_per_gpu 20 \
                  --max_epoch 512  \
                  --save_step 18000 \
                  --eval_epoch 20 \
                  --eval_start_epoch 256\
                  --log_step 20 \
                  --concat_mode 'right_concat' \
                  --save_dir T5Finetune_fewshot_right_ckpt_v$expid\_$run_id  \
                  --seed $seed \
                  --model T5Finetune \
                  --max_length 128 \
                  --max_gen_length 64 \
        ...
        echo "++++++++++++++++++++++++++++++"
        #ps aux | grep "cuda 0" | awk '{print $2}' | xargs kill -9
        let "run_id+=1"
        let "seed+=1"
      done
    done
